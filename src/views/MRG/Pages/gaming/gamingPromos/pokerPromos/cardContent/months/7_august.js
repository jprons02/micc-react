...
import cardImage3 from 'assets/media/img/mrg/monthly_promos/0_recurring/SeniorTuesdays_Logo.png';
      ...
      rules: {
        subSections: [
          ...
          },
          {
            ...
            body:
              'Must be present to win. The prize will automatically be forfeited if the player fails to independently produce the winning ticket stub, valid identification, and Player’s Card within ten (10) minutes of being announced, and another name will be drawn until the prize is claimed. Players must locate and identify the corresponding drawing stub on their own accord. Miccosukee Casino & Resort employees are not permitted to handle player retained drawing stubs once issued.',
          },
          {
            id: '411',
            title: 'Game Rules',
      ...
      rules: {
        subSections: [
          ...
          },
          {
            ...
            body:
              'Must be present to win. The prize will automatically be forfeited if the player fails to independently produce the winning ticket stub, valid identification, and Player’s Card within ten (10) minutes of being announced, and another name will be drawn until the prize is claimed. Players must locate and identify corresponding drawing stub on their own accord. Miccosukee Casino & Resort employees are not permitted to handle player retained drawing stubs once issued.',
          },
          {
            id: '613',
            title: 'Drawing Ticket / Barrel Rules',
      ...
      rules: {
        subSections: [
          ...
          { id: '21', title: 'Tipo de Promoción', body: 'Premios Ricochet' },
          {
            ...
            title: 'Reglas',
            body:
              '¡Los martes son para los adultos maduritos en Miccosukee Casino & Resort! Los días 2, 9, 16, 23 y 30 de agosto, entre las 9 AM y la medianoche, los invitados mayores de 55 años que ganen 20 puntos jugando con su tarjeta Miccosukee One recibirán $10 Free Play. Además, ¡los jugadores que ganen 100 puntos en su tarjeta Miccosukee One obtendrán un paquete de Bingo adicional gratis para el juego de ese viernes!',
          },
          {
            id: '23',
            title: 'PARA CALIFICAR',
