...
const imageObj = [
  { src: image1, alt: 'Golf Course 1' },
  { src: image2, alt: 'Golf Course 2' },
  { src: image3, alt: 'Golf Course 3' },
  { src: image4, alt: 'Golf Course 4' },
];
        ...
        <GridContainer>
          <GridItem md={7}>
            <div className={classes.leftTextArea}>
              ...
              <p>
                {language
                  ? `Golfers looking for breathtaking views and fast fairways will indulge in the Miccosukee Golf & Country Club's beauty, which boasts​ three challenging courses: Dolphin, Marlin, and, Barracuda, the crown jewels of Mark Mahannah’s course-design career.`
              ...
              <p>
                {language
                  ? `Everyone is welcome. Our course is open to club members and the public and offers challenges that have been enjoyed by casual players and some of the finest PGA and LPGA golfers. Inform us of the caliber of players you intend to have, and we’ll suggest 18 holes to give everyone a super outing.`
