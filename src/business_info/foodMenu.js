...
export const sawgrassCafeMenu = [
    ...
    subMenu: [
      {
        name: "Cold Beverages",
        items: [
          { name: "Soda Can (12 oz.)", price: "$1.38" },
          { name: "Soda Bottle (20 oz.)", price: "$2.30" },
          { name: "Fountain Soda", price: "$1.61" },
          { name: "Monster", price: "$2.76" },
          { name: "Powerade", price: "$2.30" },
          { name: "Dunkin Donuts Beverages", price: "$2.76" },
          { name: "Gold Peak Tea", price: "$2.30" },
      ...
      },
      {
        name: "Hot Beverages",
        items: [
          { name: "Hot Tea", price: "$1.15" },
          { name: "American Coffee", price: "$1.84" },
          { name: "Colada", price: "$2.07" },
          { name: "Cortadito", price: "$2.30" },
          { name: "Café con Leche", price: "$3.45" },
          { name: "Hot Chocolate", price: "$3.45" },
          { name: "Cappuccino", price: "$3.91" },
        ],
      },
    ],
  },
  ...
  },
  {
    name: "Hot Stuff",
    items: [
      { name: "Hot Dog & Fries", price: "$6.67" },
      { name: "Chicken Tenders", price: "$10.58" },
      { name: "Chicken Wings", price: "$12.88" },
    ],
  },
  {
    name: "Salad",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Tuna Salad Sandwich", price: "$8.97" },
      { name: "Hamburger", price: "$8.74" },
      { name: "Chicken Sandwich", price: "$9.20" },
      { name: "Cuban Sandwich", price: "$9.66" },
      { name: "Cheeseburger", price: "$9.84" },
      { name: "Club Sandwich", price: "$10.12" },
      { name: "Steak Palomilla Sandwich", price: "$10.76" },
    ],
  },
  {
    name: "Sides",
    items: [{ name: "French Fries (8 oz.)", price: "$3.32" }],
  },
  {
    name: "Soup",
    items: [
  ...
  },
  {
    name: "Pizza",
    items: [
      { name: "Cheese Pizza (Slice)", price: "$3.63" },
      { name: "Pepperoni Pizza (Slice)", price: "$3.91" },
      { name: "Whole Pizza", price: "$19.32" },
    ],
  },
];
